...
def get_nfl_team_roster_url_path(team_id: str):
    return nfl_api_base_url + "/" + access_level + "/" + api_version + "/" + english_lang_code + "/teams/" + team_id + "/full_roster.json?api_key=" + get_sport_radar_api_key()


def get_nfl_team_profile_url_path(team_id: str):
    return nfl_api_base_url + "/" + access_level + "/" + api_version + "/" + english_lang_code + "/teams/" + team_id + "/full_roster.json?api_key" + get_sport_radar_api_key()
