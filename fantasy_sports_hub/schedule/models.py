...
class NflGame(models.Model):
    ...
    home_team_id = models.ForeignKey(
        NflTeam, on_delete=models.CASCADE, related_name="home_team", blank=True, null=True)
    ...
    away_team_id = models.ForeignKey(
        NflTeam, on_delete=models.CASCADE, related_name="away_team", blank=True, null=True)
